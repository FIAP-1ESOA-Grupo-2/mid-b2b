    ...
    return (
        <section className="m-4 p-4">
            ...
            <div className="flex items-center bg-formbg my-3 p-4 rounded-xl">
                ...
                <input className="text-2xl text-textgrey w-full bg-transparent outline-none active:text-textgrey"
                    type="text"
                    value={searchQuery}
                    onChange={(e) => {
            ...
            <ul className="mx-auto bg-white rounded pl-1 pr-8 pt-6 pb-8 flex flex-wrap gap-4">
                {todos.map((todo) => (
                    <li key={todo.id}
